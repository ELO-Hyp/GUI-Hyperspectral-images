...
class DRWindow_nmf:
    ...
    def __process(self, output_dir: str):
        try:
            ...
            no_bands = 10
            dr_nmf = nmf.NMF(n_bands=no_bands)
            dr_nmf.fit(hyp_img)
            hyp_img_red = dr_nmf.transform(hyp_img)
            ...
            path_to_save_imgred = os.path.join(output_dir, "reduced_hypImg_nmf.mat")
