...
class DRWindow_lpp:
    ...
    def __process(self, output_dir: str):
        try:
            ...
            dr_lpp = lpp.LPP(n_bands = no_bands)
            dr_lpp.fit(hyp_img)
            hyp_img_red = dr_lpp.transform(hyp_img)
            ...
            path_to_save_imgred = os.path.join(output_dir, "reduced_hypImg_lpp.mat")
