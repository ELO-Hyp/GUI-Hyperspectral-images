...
class DRWindow_osp:
    ...
    def __process(self, output_dir: str):
        try:
            ...
            dr_osp.fit(hyp_img.T)
            hyp_img_red = dr_osp.transform(hyp_img)
            ...
            path_to_save_imgred = os.path.join(output_dir, "reduced_hypImg_osp.mat")
